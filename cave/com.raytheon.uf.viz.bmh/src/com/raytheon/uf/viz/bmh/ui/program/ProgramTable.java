 ...
 * @version 1.0
 */
public class ProgramTable extends TableComp {
    /**
     * Constructor.
     * 
     * @param parentComp
     ...
     *            Table height.
     */
    public ProgramTable(Composite parentComp, int width, int height) {
     ...
     *            Table height.
     */
    public ProgramTable(Composite parentComp, int tableStyle, int width,
            int height) {
