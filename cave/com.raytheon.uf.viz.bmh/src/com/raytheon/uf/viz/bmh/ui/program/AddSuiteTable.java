...
/**
 * 
 * Table used for adding or copying in suites.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * @version 1.0
 */
public class AddSuiteTable extends TableComp {
     ...
     *            Table height.
     */
    public AddSuiteTable(Composite parentComp, int width, int height) {
     ...
     *            Table height.
     */
    public AddSuiteTable(Composite parentComp, int tableStyle, int width,
            int height) {
