...
/**
 * 
 * Table to hold the transmitter information.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * ------------ ---------- ----------- --------------------------
 * Jul 15, 2014  #3174      lvenable     Initial creation
 * 
 * </pre>
 * 
 * @author lvenable
 * @version 1.0
 */
public class TransmitterTable extends TableComp {
     ...
     *            Table height.
     */
    public TransmitterTable(Composite parentComp, int width, int height) {
     ...
     *            Table height.
     */
    public TransmitterTable(Composite parentComp, int tableStyle, int width,
            int height) {
