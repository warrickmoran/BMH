...
/**
 * JAXB representation of the SSML meta tag.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 * 
 */
@XmlRootElement(name = SsmlMeta.NAME)
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "ssml-meta")
public class SsmlMeta implements Serializable {
    
    public static final String NAME = "meta";

    private static final long serialVersionUID = -7077942729931413055L;
