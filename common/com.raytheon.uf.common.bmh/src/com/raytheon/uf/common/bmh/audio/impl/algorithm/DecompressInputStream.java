 ...
 * ------------ ---------- ----------- --------------------------
 * Jul 18, 2014 3383       bkowal      Initial creation
 * 
 * </pre>
 * 
 * @author bkowal
...
public class DecompressInputStream extends FilterInputStream {
    ...
    /*
     * Added by bkowal 07/21/2014
     */
    public static enum DECOMPRESSION_TYPE {
        /* enum constant for alaw decompression */
        ALAW(alawtable),
        /* enum constant for ulaw decompression */
        ULAW(ulawtable);

        private DECOMPRESSION_TYPE(final int[] lookupTable) {
     ...
     *            enum corresponding to the decompression lookup table that
     *            should be used.
     * @throws IOException
     */
    public DecompressInputStream(InputStream in,
            DECOMPRESSION_TYPE decompressionType) throws IOException {
        super(in);
        table = decompressionType.getLookupTable();
    }
    ...
    /**
     * Copies the decompressed data into the specified destination array
     * 
     * @param b
     *            the destination array that the decompressed data will be
     *            written to
     * @return the number of decompressed bytes that were copied into the array.
     */
    ...
    /**
     * Copies the decompressed data into the specified destination array
     * starting at index off for a total of len bytes
     * 
     * @param b
     *            the destination array that the decompressed data will be
     *            written to
