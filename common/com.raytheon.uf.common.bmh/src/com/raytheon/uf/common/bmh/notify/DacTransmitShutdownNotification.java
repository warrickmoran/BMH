...
/**
 * Notification used to notify the PlaylistStateManager that a dac transmit
 ...
 */
@DynamicSerialize
public class DacTransmitShutdownNotification {
     ...
     */
    public DacTransmitShutdownNotification() {
    }

    public DacTransmitShutdownNotification(String transmitterGroup) {
